...
public class JMSBulkSender {
	...
	public static void main(String[] args) throws Exception{
		...
		String factoryName = System.getProperty("factoryName");
		String numberOfThreads = System.getProperty("numberOfThreads");
		String sleepTime = System.getProperty("sleepTime");
		String connectionFactory = System.getProperty("connectionFactory");
		...
		try {
			...
			properties.put(Context.INITIAL_CONTEXT_FACTORY, connectionFactory);
