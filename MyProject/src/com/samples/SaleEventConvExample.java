...
public class SaleEventConvExample {
	...
	public static void main(String[] args)
	{
		...
		SaleEventConvExample obj = new SaleEventConvExample();
	...
	private void invokeSaleEvent(InitialContext initCtx, String[] args) {
		...
		custInfo.setCustomerType((byte)'R');
		custInfo.setCustomerSubtype("I");
		...
		try
		{
			...
			//eventInfo=saleServices.getEventDetails(customerIdInfo, subscriberIdInfo, eventIdInfo, flexibleCycleInfo, eventTypeInfo, null);
